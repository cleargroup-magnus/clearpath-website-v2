...
const services: Service[] = [
  {
    ...
    tag: "Build",
    desc: "High-converting websites and platforms built for performance — not just looks.",
  ...
  },
  {
    ...
    tag: "Intelligent",
    desc: "Practical AI applied where it creates real value — support, ops, and content.",
  ...
  },
  {
    ...
    tag: "Automate",
    desc: "We remove repetitive tasks and streamline your operations — saving hours every week.",
  ...
  },
  {
    ...
    tag: "Growth",
    desc: "Paid campaigns focused on measurable return — not vanity metrics.",
